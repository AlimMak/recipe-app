  ...
  return (
    <div className='bg-[#faf9fb] p-10 flex-1'>
      <div className='max-w-screen-lg mx-auto'>
        ...
        <h1 className="font-bold text-3xl md:text-5x mt-4">Recommended Recipes</h1>
        <p className="text-slate-500 font-semibold ml-1 my-2 text-sm tracking-tight">Popular choices</p>

        <div className='grid gap-3 grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
          {!loading && Recipes.map(({recipe},index) => (<RecipeCard key={index} recipe={recipe} {...getRandomColor()} />  
